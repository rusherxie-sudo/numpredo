...
export const VARIANTS: Variant[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '6×6数独はどこで遊べますか？', a: '当サイトでは6×6はルール解説のみです。プレイできるのは9×9の数独で、<a href="/play/beginner/">難易度別プレイ</a>のほか<a href="/variants/diagonal/">対角線数独（X数独）</a>も遊べます。考え方は同じなので、まずは初級で基本に慣れてから挑戦するのがおすすめです。' },
    ],
  },
  {
    slug: 'inequality',
