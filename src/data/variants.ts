...
export const VARIANTS: Variant[] = [
  ...
  },
  {
    ...
    description: '不等号ナンプレ（比較数独）のルールと解き方を解説。マスの間の「＜」「＞」の大小関係を手がかりに数字を絞り込む変種数独です。基本ルールとの違いとコツを図解で紹介します。',
    h1: '不等号ナンプレ（比較数独）のルールと解き方',
    lead: 'ナンプレの不等号ルールでは、マスとマスの間の「＜」「＞」の大小関係を手がかりに数字を絞り込みます。',
