...
export const VARIANTS: Variant[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: '子どもへの教え方', body: ['お子さんと解くときは、まず<strong>1つのブロック（2×3）を埋めることだけ</strong>に集中させると分かりやすくなります。「このかたまりに1から6を1回ずつ」というルールから始め、慣れてきたら行・列にも目を向けさせましょう。', '数字に苦手意識があるお子さんには、1〜6を書いた数字カードを「置く」感覚で教えるのもおすすめです。論理的に考える力や集中力をはぐくむ<a href="/guide/brain-training/">脳トレ</a>にもなります。'] },
